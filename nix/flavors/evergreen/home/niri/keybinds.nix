{
  programs.niri.settings.binds = {
    ...
    "Mod+Space" = {
      action.spawn = [ "caelestia-launcher" ];
    };
    "Ctrl+Mod+Shift+L" = {
      action.spawn = [ "caelestia-session" ];
    };
    "Mod+Shift+L" = {
      action.spawn = [ "caelestia-lock" ];
    };
    "Mod+Shift+P" = {
      action.spawn = [ "caelestia-showall" ];
    };

    # Media controls
    "Ctrl+Mod+Space" = {
      action.spawn = [ "caelestia-media-toggle" ];
    };
    "Ctrl+Mod+Equal" = {
      action.spawn = [ "caelestia-media-next" ];
    };
    "Ctrl+Mod+Minus" = {
      action.spawn = [ "caelestia-media-prev" ];
    };
    "Ctrl+Mod+C" = {
      action.spawn = [ "caelestia-clear-notifs" ];
    };
    ...
    "XF86AudioStop" = {
      action.spawn = [ "caelestia-media-stop" ];
    };
    "XF86AudioMute" = {
    ...
    # Brightness controls
    "XF86MonBrightnessUp" = {
      action.spawn = [ "caelestia-brightness-up" ];
    };
    "XF86MonBrightnessDown" = {
      action.spawn = [ "caelestia-brightness-down" ];
    };

    # Screenshots
    "Print" = {
      action.spawn = [ "caelestia-screenshot" ];
    };
    "Shift+Mod+S" = {
      action.spawn = [ "caelestia-screenshot-freeze" ];
    };
    "Shift+Mod+Alt+S" = {
      action.spawn = [ "caelestia-screenshot" ];
    };
    ...
    "Mod+S" = {
      action.focus-workspace = 99;
    };
    "Shift+Mod+S" = {
      action.move-window-to-workspace = 99;
    };
